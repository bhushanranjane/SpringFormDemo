...
<body>
	...
	<form:form modelAttribute="countryForm" action="countryForm.html"
		method="post">
		<table>
			<tr>
				<td align="right" valign="bottom"><c:choose>
						<c:when test="${CountryForm}">
							<button type="submit" name="create">Create</button>
						</c:when>
						<c:otherwise>
							<button type="submit" name="delete"
								onclick="return confirm('Are you sure you want to delete ${countryForm.name}?')">
								Delete</button>
				...
				<td>
					<table class="silver">
						...
						<tr>
							...
							<td><form:input path="name" size="20" maxlength="50" /> 
